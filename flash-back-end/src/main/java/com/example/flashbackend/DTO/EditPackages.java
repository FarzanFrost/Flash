...
public class EditPackages {
    ...
    public EditPackages(BigInteger packageID, String frame, int videographer, int photographer, boolean calender, String name, int pages, float extraPagesPrice, String outShootType, boolean signatureFrame, String albumDesign, float totalPayment, String eventType, String additional) {
